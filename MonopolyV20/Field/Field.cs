...
namespace MonopolyV20
{
    public class Field
    {
        ...
        public void AddingField()
        {
            ...
            Buldings.Add(new Business("Adidas", 6, 1000, 500, 600, 0, 500, new List<int>() { 60, 300, 900, 2700, 4000, 5500 }, BusinessType.ClothingStores));
            Buldings.Add(new Chance("Шанс", 7));
            ((Chance)Buldings[Buldings.Count - 1]).AddChance();
            Buldings.Add(new Business("Puma", 8, 1000, 500, 600, 0, 500, new List<int>() { 60, 300, 900, 2700, 4000, 5500 }, BusinessType.ClothingStores));
            Buldings.Add(new Business("LACOSTE", 9, 1200, 600, 720, 0, 500, new List<int>() { 80, 400, 1000, 3000, 4500, 6000 }, BusinessType.ClothingStores));
            ...
            ((Chance)Buldings[Buldings.Count - 1]).AddChance();
            Buldings.Add(new Business("Lufthansa", 23, 2200, 1100, 1320, 0, 1250, new List<int>() { 180, 900, 2500, 7000, 8750, 10500 }, BusinessType.Airlines));
            Buldings.Add(new Business("Brit.Air", 24, 2400, 1200, 1440, 0, 1250, new List<int>() { 200, 1000, 3000, 7500, 9250, 11000 }, BusinessType.Airlines));
            Buldings.Add(new CarInterior("Ford", 25, 2000, 1000, 1200, 0, new List<int>() { 250, 500, 1000, 2000 }, BusinessType.Car));
            Buldings.Add(new Business("McDonalds", 26, 2600, 1300, 1560, 0, 1500, new List<int>() { 220, 1100, 3300, 8000, 9750, 11500 }, BusinessType.Restaurants));
            Buldings.Add(new Business("BurgerKing", 27, 2600, 1300, 1560, 0, 1500, new List<int>() { 220, 1100, 3300, 8000, 9750, 11500 }, BusinessType.Restaurants));
            Buldings.Add(new GamingCompanies("Rovio", 28, 1500, 750, 900, 0, new List<int>() { 100, 250 }, BusinessType.GameCorparation));
            Buldings.Add(new Business("KFC", 29, 2800, 1400, 1680, 0, 1500, new List<int>() { 240, 1200, 3600, 8500, 10250, 12000 }, BusinessType.Restaurants));
            Buldings.Add(new PoliceStation("Полицейский участок", 30));
            Buldings.Add(new Business("Holiday Inn", 31, 3000, 1500, 1800, 0, 1750, new List<int>() { 260, 1300, 3900, 9000, 11000, 12750 }, BusinessType.Hotels));
            Buldings.Add(new Business("Radissom Blu", 32, 3000, 1500, 1800, 0, 1750, new List<int>() { 260, 1300, 3900, 9000, 11000, 12750 }, BusinessType.Hotels));
            Buldings.Add(new Chance("Шанс", 33));
            ((Chance)Buldings[Buldings.Count - 1]).AddChance();
            Buldings.Add(new Business("Novotel", 34, 3200, 1600, 1920, 0, 1750, new List<int>() { 280, 1500, 4500, 10000, 12000, 14000 }, BusinessType.Hotels));
            ...
            Buldings.Add(new Business("Apple", 37, 3500, 1750, 2100, 0, 2000, new List<int>() { 350, 1750, 5000, 11000, 13000, 15000 }, BusinessType.Electronics));
            Buldings.Add(new Chance("Шанс", 38));
            ((Chance)Buldings[Buldings.Count - 1]).AddChance();
            Buldings.Add(new Business("Nokia", 39, 4000, 2000, 2400, 0, 2000, new List<int>() { 500, 2000, 6000, 14000, 17000, 20000 }, BusinessType.Electronics));
                        ...
                        if (Buldings[cellNumber[j]].GetType() == typeof(Business))
                        {
                            ...
                            if (((Business)Buldings[cellNumber[j]]).Mortgaged == true)
                            {
                                for (int k = 0; k < ((Business)Buldings[cellNumber[j]]).Level.ToString().Length; k++)
                                {
                                    ...
                                    isColor = !isColor;
                                    Console.Write(((Business)Buldings[cellNumber[j]]).Level.ToString()[k]);
                                }
                            }
                            else Console.Write($"{((Business)Buldings[cellNumber[j]]).Level}");
