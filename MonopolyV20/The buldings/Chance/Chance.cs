...
namespace MonopolyV20
{
    public class Chance : Building
    {
        ...
        private void AddChance()
        {
            ...
            Chances.Add(new Lesion(1000, "{ Обучение }", "Конец учебного года закончился и вам надо оплатить дальнешее обучение в универе 1000"));
            ...
            Chances.Add(new Profit(250, "{ Бонус }", "Вы шли домой и нашли 250"));
